class Netwatch < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/vietcgi/netwatch/releases/download/v0.2.0/netwatch-macos-arm64.tar.gz"
      sha256 "6060b0776433df2bc6660683240e0498810a3e074cbf1d24ed06404b9a037a4e"
    else
      url "https://github.com/vietcgi/netwatch/releases/download/v0.2.0/netwatch-macos-x86_64.tar.gz"
